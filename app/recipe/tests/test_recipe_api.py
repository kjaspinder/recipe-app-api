...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='crepes')
        tag1 = sample_tag(user=self.user, name='vegan')
        tag2 = sample_tag(user=self.user, name='vegetarian')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='fish and chips')
        # second argument is for filtering out only recipes with tags
        res = self.client.get(
            RECIPES_URL,
    ...
    def test_filter_recipes_by_ingredient(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Coconut')
